...
<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
                            ...
                            <li class="active"><a href="#"><?=$chapter['chapter_name'];?></a></li>
						</ul>
...
function final_submission(){
	...
	$.ajax({
                type      : 'POST',
                url       : '<?php echo base_url('secure/chapter/getResult');?>',
				data	  : 'data='+data,
                dataType  :'JSON',
                success   : function(response){
					console.log(response);
					var url = '<?php echo base_url('secure/chapter/showResult');?>'+'/'+response.rowid;
