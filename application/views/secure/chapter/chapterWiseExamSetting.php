...
<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-4">
										<fieldset>
											<legend class="text-semibold"> Chapter wise Exam setting</legend>
                         <?php echo form_open_multipart('secure/chapter/Setting', array('class'=>'form-horizontal')); ?>
...
<script type="text/javascript"> 
		...
		function getexamsettingDetail(getId){
				$.ajax({
							type:'POST',
							url:'<?php echo base_url('secure/chapter/getexamsettingDetail');?>',
							data:'getId='+getId,
							dataType:'json',
