                            ...
                            <div class="panel-group content-group-lg" id="accordion1">
								<div class="panel panel-info">
									...
									<div id="accordion-group1" class="panel-collapse collapse">
                                        ...
                                        <?php 
										foreach($subList as $sk=>$sub):
										$subName = $this->Chapter_model->get_selected_value('sub_name', 'tbl_subject', array('id'=>$sub));?>
                                        <h4 class="bg-pink-800" style="text-align:center;"><?=$subName['sub_name'];?></h4>
										<?php $i=1;
										...
										if($ques[1] != $ques[2]){
											...
											$quesData = $this->Chapter_model->get_selected_value($v, 'tbl_question', array('id'=>$ques[0],'sub_id'=>$sub));
