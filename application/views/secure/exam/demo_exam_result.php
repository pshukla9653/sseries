                            ...
                            <div class="panel-group content-group-lg" id="accordion1">
								<div class="panel panel-info">
									...
									<div id="accordion-group1" class="panel-collapse collapse">
										...
										$subName = $this->Exam_model->get_selected_value('sub_name', 'tbl_subject', array('id'=>$sub));?>
										...
										if($ques[1] != $ques[2]){
											...
											$quesData = $this->Exam_model->get_selected_value($v, 'tbl_question', array('id'=>$ques[0],'sub_id'=>$sub));
