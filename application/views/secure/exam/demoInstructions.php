				...
				<div class="content">
					...
					<div class="panel panel-flat col-sm-12">
							<div class="panel-heading">
								<h5 class="panel-title">Demo Exam</h5>
...
<p style="font-weight:bold; color:#A8070A;">Note: Attempted Questions only considered for evaluation.</p>
<?php foreach($examlist as $exam){ 
$getdemoresult = $this->Exam_model->get_data('tbl_result_demo', array('student_id'=>$this->session->userdata('id'),'exam_id'=>$exam['id']));
if($getdemoresult['id']){
?>
<div class="col-sm-6"><center><a href="<?=base_url('secure/exam/Exam_demo/'.$exam['id']);?>" style="margin:5px;" class="btn btn-success">Start Demo Exam For <?=$exam['exam_name'];?></a></center>

</div>
	<div class="col-sm-6"><center><a href="<?=base_url('secure/exam/showdemoResult/'.$getdemoresult['id']);?>" style="margin:5px;" class="btn btn-success">View Previous Result For <?=$exam['exam_name'];?></a></center>

</div>							
<?php }else{?>
<div class="col-sm-12"><center><a href="<?=base_url('secure/exam/Exam_demo/'.$exam['id']);?>" style="margin:5px;" class="btn btn-success">Start Demo Exam For <?=$exam['exam_name'];?></a></center>
