...
<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="#">Main Exam</a></li>
								...
								<div class="panel panel-white">
									...
									<div id="accordion-control-right-group<?=$r;?>" class="panel-collapse collapse <?=$r==1?'in':'';?>">
                                        ...
                                        <?php for($i=0; $i < count($question); $i++){?>
											<a onClick="getquesbyids(<?=$question[$i]['id'];?>, <?=$question[$i]['marks'];?>, <?=$a;?>)" id="<?=$a;?>"><span id="bg<?=$a;?>" class="badge bg-primary" style="margin:5px;"><?=$a;?></span></a>
...
function final_submission(){
	...
	$.ajax({
                type      : 'POST',
                url       : '<?php echo base_url('secure/exam/getResult');?>',
				data	  : 'data='+data,
                dataType  :'JSON',
                success   : function(response){
					console.log(response);
					var url = '<?php echo base_url('secure/exam/showResult');?>'+'/'+response.rowid;
