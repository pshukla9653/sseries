                    ...
                    <?=form_open('secure/auth/login');?>
						<div class="panel panel-body login-form">
							<div class="text-center">
								...
								<h5 class="content-group-lg">Signin to your account <small class="display-block">Enter your password</small></h5>
							</div>
<?php echo $this->session->flashdata('msg'); ?>
							<div class="form-group has-feedback has-feedback-left">
				<?=form_input(array('class'=>'form-control', 'name'=>'username','placeholder'=>'Username','value'=>$this->session->userdata('username'), 'readonly'=>'readonly'));?>
