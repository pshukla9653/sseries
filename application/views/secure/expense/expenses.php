...
<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="row">
                                <fieldset>
											<legend class="text-semibold"> Add Expense</legend>
                                  <?php echo form_open_multipart('secure/expenses/recordexpenses', array('class'=>'form-horizontal')); ?>
                               <?php echo $this->session->flashdata('msg'); ?>              
                                ...
                                <option value="<?=$c['id'];?>" <?=$c['id']==set_select('category_id')?'selected':'';?>><?=$c['category_name'];?></option>
                                <?php }?>
                                </select>
								...
								<div class="col-lg-9">
                                <input type="text" id="full_name" class="form-control" name="full_name" placeholder="Full Name" value="<?php echo set_value('full_name'); ?>">
                            ...
                            <div class="form-group">
								...
								<div class="col-lg-9">
                                <input type="date" class="form-control" name="voucher_date" value="<?php echo date("Y-m-d"); ?>">
                             ...
                             <div class="form-group">
								...
								<div class="col-lg-9">
                                <input type="number" id="voucher_date" class="form-control" name="amount" placeholder="Amount" value="<?php echo set_value('amount'); ?>">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
								...
								<div class="col-lg-9">
                                <input type="text" class="form-control" name="authorized_signatory" placeholder="Name" value="<?php echo set_value('authorized_signatory'); ?>">
