...
<div class="panel panel-flat">
                         ...
                         <?php echo form_open_multipart('secure/question/add', array('class'=>'form-horizontal')); ?>
...
<div class="col-sm-3">
	...
	<div class="form-group">
								...
								<div class="col-md-12">
									...
									<div class="col-md-12">
                                   <textarea id="summernote" name="ques"></textarea>
                                    </div>
                                    <div class="col-md-12">
								...
								<div class="tab-content">
									<div class="tab-pane" id="highlighted-justified-tab1">
										 <textarea id="summernote1" name="opt_1"></textarea>
									</div>
                                    <div class="tab-pane fade" id="highlighted-justified-tab2">
										 <textarea id="summernote2" name="opt_2"></textarea>
									</div>
                                    <div class="tab-pane fade" id="highlighted-justified-tab3">
										 <textarea id="summernote3" name="opt_3"></textarea>
									</div>
                                    <div class="tab-pane fade" id="highlighted-justified-tab4">
										 <textarea id="summernote4" name="opt_4"></textarea>
									</div>
