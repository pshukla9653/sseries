...
<div class="panel panel-flat">
    ...
    <div class="col-md-3">
    <a href="<?php echo base_url('secure/question/QuestionList');?>" class="btn btn-primary btn-lg pull-right">Search Question</a>
    </div>
</div>
                                    <div class="col-md-12">
                      ...
                      <th>Action</th>
                                    ...
                                    <td>
                                       ...
                                       <td><?php echo $item['ques']; ?></td>
                                        <td><?php echo ($item['is_correct'] == 1) ? '<span class="btn btn-success">Yes</span>':'<span class="btn btn-danger">No</span>'; ?></td>
               ...
               | <a class="text-info" href="<?php echo base_url('secure/question/editQ/'.$item['id']);?>" target="_blank">Edit</a>                       
