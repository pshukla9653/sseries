...
<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-4">
										<fieldset>
						<legend class="text-semibold"> Subject wise Exam setting</legend>
                         <?php echo form_open_multipart('secure/subject/Setting', array('class'=>'form-horizontal')); ?>
...
<script type="text/javascript"> 
    ...
    $('#exam_id').on('change',function(){
		...
		function getexamsettingDetail(getId){
				$.ajax({
							type:'POST',
							url:'<?php echo base_url('secure/subject/getexamsettingDetail');?>',
							data:'getId='+getId,
							dataType:'json',
