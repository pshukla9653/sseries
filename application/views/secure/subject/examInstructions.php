...
<div class="col-sm-12"><center><a href="<?=base_url('secure/subject/startSubjectExam/'.$exam_id.'/'.$sub_id.'/'.$class_id);?>" style="margin:5px;" class="btn btn-success">Start Exam</a></center>
