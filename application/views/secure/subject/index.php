								...
								<div class="row">
									<div class="col-md-4">
										<fieldset>
                                            ...
                                            <?php echo form_open_multipart('secure/subject/index', array('class'=>'form-horizontal')); ?>
                               <?php echo $this->session->flashdata('msg'); ?>            
                                           
											<div class="form-group">
                                <label class="col-lg-3 control-label">Subject Name</label>
												<div class="col-lg-9">
                                <input type="text" id="sub_name" class="form-control" name="sub_name" placeholder="Subject Name" value="<?php echo set_value('sub_name'); ?>" >
...
<script type="text/javascript"> 
		...
		function editExpenses(getId){
				$.ajax({
							type:'POST',
							url:'<?php echo base_url('secure/subject/getsubjectDetail');?>',
							data:'getId='+getId,
							dataType:'json',
							success:function(response){
								//console.log(response);
								$('#sub_name').val(response.founddata.sub_name);
